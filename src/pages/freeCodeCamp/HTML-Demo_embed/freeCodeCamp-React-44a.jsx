...
var MyToDoList = function (_React$Component) {
  ...
  var _super = _createSuper(MyToDoList);
  ...
  _createClass(MyToDoList, [{
    ...
    value: function render() {
      var items = this.state.toDoList.map(function (i) {
      ...
      }, "Create List"), React.createElement("h1", null, "My \"To Do\" List:"), React.createElement("ul", null, items));
    }
  }]);
...
ReactDOM.render( React.createElement(MyToDoList, null), document.getElementById('root'));
