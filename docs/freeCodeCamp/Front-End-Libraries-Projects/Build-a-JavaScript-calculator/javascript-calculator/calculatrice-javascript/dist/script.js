...
class Calculatrice extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(Output, { currentValue: this.state.display }), /*#__PURE__*/
...
class Buttons extends React.Component {
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("button", { value: "AC", className: "btn btn-info allClear", id: "clear", onClick: this.props.init }, "AC"), /*#__PURE__*/
      React.createElement("button", { value: "CE", className: "btn btn-info clearEntry", id: "clearEntry", onClick: this.props.handleCE }, "CE"), /*#__PURE__*/
      React.createElement("button", { value: "\xB1", className: "btn btn-secondary toggleSign", id: "toggleSign", onClick: this.props.handleToggleSign }, "\xB1"), /*#__PURE__*/
      React.createElement("button", { value: "/", className: "btn btn-secondary divide", id: "divide", onClick: this.props.handleOperators }, "/"), /*#__PURE__*/
      React.createElement("button", { value: "7", className: "btn btn-light seven", id: "seven", onClick: this.props.handleNumbers }, "7"), /*#__PURE__*/
      React.createElement("button", { value: "8", className: "btn btn-light eight", id: "eight", onClick: this.props.handleNumbers }, "8"), /*#__PURE__*/
      React.createElement("button", { value: "9", className: "btn btn-light nine", id: "nine", onClick: this.props.handleNumbers }, "9"), /*#__PURE__*/
      React.createElement("button", { value: "x", className: "btn btn-secondary multiply", id: "multiply", onClick: this.props.handleOperators }, "x"), /*#__PURE__*/
      React.createElement("button", { value: "4", className: "btn btn-light four", id: "four", onClick: this.props.handleNumbers }, "4"), /*#__PURE__*/
      React.createElement("button", { value: "5", className: "btn btn-light five", id: "five", onClick: this.props.handleNumbers }, "5"), /*#__PURE__*/
      React.createElement("button", { value: "6", className: "btn btn-light six", id: "six", onClick: this.props.handleNumbers }, "6"), /*#__PURE__*/
      React.createElement("button", { value: "-", className: "btn btn-secondary subtract", id: "subtract", onClick: this.props.handleOperators }, "-"), /*#__PURE__*/
      React.createElement("button", { value: "1", className: "btn btn-light one", id: "one", onClick: this.props.handleNumbers }, "1"), /*#__PURE__*/
      React.createElement("button", { value: "2", className: "btn btn-light two", id: "two", onClick: this.props.handleNumbers }, "2"), /*#__PURE__*/
      React.createElement("button", { value: "3", className: "btn btn-light three", id: "three", onClick: this.props.handleNumbers }, "3"), /*#__PURE__*/
      React.createElement("button", { value: "+", className: "btn btn-secondary add", id: "add", onClick: this.props.handleOperators }, "+"), /*#__PURE__*/
      React.createElement("button", { value: "0", className: "btn btn-light zero", id: "zero", onClick: this.props.handleNumbers }, "0"), /*#__PURE__*/
      React.createElement("button", { value: ".", className: "btn btn-light decimal", id: "decimal", onClick: this.props.handleDecimal }, "."), /*#__PURE__*/
      React.createElement("button", { value: "=", className: "btn btn-success equals", id: "equals", onClick: this.props.handleEval }, "=")));
...
const Output = props => {
  return /*#__PURE__*/React.createElement("div", { className: "outputScreen", id: "display" }, props.currentValue);
};

const Formula = props => {
  return /*#__PURE__*/React.createElement("div", { className: "formulaScreen" }, props.formula);
};

const Author = () => /*#__PURE__*/
React.createElement("div", { className: "author" }, "Fait \xE0 la main par", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/
React.createElement("a", { target: "_blank", rel: "noreferrer", href: "https://codepen.io/gylgyl2000" }, "LaLoutre"));
...
const App = () => /*#__PURE__*/
React.createElement("div", null, /*#__PURE__*/
React.createElement(Calculatrice, null), /*#__PURE__*/
